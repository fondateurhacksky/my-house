...
export default function Article3({ isSection3And4Visible }: { isSection3And4Visible: boolean }) {
  ...
  const translateXTransitionClass = isSection3And4Visible
    ...
    : "translate-x-[-240%] transition-transform duration-500 delay-0";
    ...
    return (  
        <article
         className={`
         bg-white border-y-2 border-2 rounded-r-lg p-5 border-slate-700 md:col-start-7 md:col-end-12  
        ...
        >
            ...
            <h1 className="text-xl text-center">Pourquoi nous ?</h1>

            <p className="text-justify"> Lorem ipsum dolor sit amet consectetur adipisicing elit.
           Eos doloribus nesciunt dolor architecto, saepe aut magni et distinctio deserunt  . . .
