export default function Text() {
    return (
        <div className={'z-1'}>
            <p className='uppercase text-n  color-tcolor text-transparent font-light animate-textReveal'>
            ...
            <p className='uppercase text-n font-black color-tcolor text-transparent animate-[textReveal_0s_1.25s_forwards]'>
                ...
                after:left-0 after:bg-[#008000]  after:animate-[slideOut_0.75s_1.3s_ease-out_forwards]'>
